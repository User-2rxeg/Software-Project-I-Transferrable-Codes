...
export class AdminService {
    ...
    async securityOverview(params?: { limit?: number; from?: string; to?: string }) {
        ...
        const q: FilterQuery<AuditLogDocument> = {
            ...
            event: {$in: [Logs.LOGIN_FAILED, Logs.UNAUTHORIZED_ACCESS, Logs.TOKEN_BLACKLISTED, Logs.RBAC_DENIED, Logs.ADMIN_FORCE_LOGOUT, Logs.ADMIN_USER_LOCK, Logs.ADMIN_USER_UNLOCK,]},
        };
