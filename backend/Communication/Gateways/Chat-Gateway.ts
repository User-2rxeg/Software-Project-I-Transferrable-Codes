// src/Communication/Gateways/Chat-Gateway.ts
...
//     async onMessageSend(@ConnectedSocket() client: Socket, @MessageBody() payload: { conversationId: string; content?: string; attachmentUrl?: string }) {
...
//     async onMessageRead(@ConnectedSocket() client: Socket, @MessageBody() body: { conversationId: string; upToMessageId?: string }) {
//         const userId = client.data.userId as string;
